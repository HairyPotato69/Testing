...
'WI', '54702', '7155552345', 'SR', TO_DATE('08/19/1985', 'MM/DD/YYYY'), 1230, 1, TO_YMINTERVAL('4-6'));
...
INSERT INTO term VALUES (1, 'Fall 2005', 'CLOSED');

INSERT INTO term VALUES (2, 'Spring 2006', 'CLOSED');

INSERT INTO term VALUES (3, 'Summer 2006', 'CLOSED');

INSERT INTO term VALUES (4, 'Fall 2006', 'CLOSED');

INSERT INTO term VALUES (5, 'Spring 2007', 'CLOSED');

INSERT INTO term VALUES (6, 'Summer 2007', 'OPEN');
...
INSERT INTO course VALUES (5, 'MIS 451', 'Web-Based Systems', 3);

--- inserting records into COURSE_SECTION
INSERT INTO course_section VALUES
(1, 1, 4, 1, 2, 'MWF', TO_DATE('10:00', 'HH:MI'), TO_DSINTERVAL('0 00:00:50.00'), 1, 140);

INSERT INTO course_section VALUES
(2, 1, 4, 2, 3, 'TR', TO_DATE('09:30', 'HH:MI'), TO_DSINTERVAL('0 00:01:15.00'), 7, 35);

INSERT INTO course_section VALUES
(3, 1, 4, 3, 3, 'MWF', TO_DATE('08:00', 'HH:MI'), TO_DSINTERVAL('0 00:00:50.00'), 2, 35);

INSERT INTO course_section VALUES
(4, 2, 4, 1, 4, 'TR', TO_DATE('11:00', 'HH:MI'), TO_DSINTERVAL('0 00:01:15.00'), 6, 35);

INSERT INTO course_section VALUES
(5, 2, 5, 2, 4, 'TR', TO_DATE('02:00', 'HH:MI'), TO_DSINTERVAL('0 00:01:15.00'), 6, 35);

INSERT INTO course_section VALUES
(6, 3, 5, 1, 1, 'MWF', TO_DATE('09:00', 'HH:MI'), TO_DSINTERVAL('0 00:00:50.00'), 5, 30);

INSERT INTO course_section VALUES
(7, 3, 5, 2, 1, 'MWF', TO_DATE('10:00', 'HH:MI'), TO_DSINTERVAL('0 00:00:50.00'), 5, 30);

INSERT INTO course_section VALUES
(8, 4, 5, 1, 5, 'TR', TO_DATE('08:00', 'HH:MI'), TO_DSINTERVAL('0 00:01:15.00'), 3, 35);

INSERT INTO course_section VALUES
(9, 5, 5, 1, 2, 'MWF', TO_DATE('02:00', 'HH:MI'), TO_DSINTERVAL('0 00:00:50.00'), 5, 35);

INSERT INTO course_section VALUES
(10, 5, 5, 2, 2, 'MWF', TO_DATE('03:00', 'HH:MI'), TO_DSINTERVAL('0 00:00:50.00'), 5, 35);

INSERT INTO course_section VALUES
(11, 1, 6, 1, 1, 'MTWRF', TO_DATE('08:00', 'HH:MI'), TO_DSINTERVAL('0 00:01:30.00'), 1, 50);

INSERT INTO course_section VALUES
(12, 2, 6, 1, 2, 'MTWRF', TO_DATE('08:00', 'HH:MI'), TO_DSINTERVAL('0 00:01:30.00'), 6, 35);

INSERT INTO course_section VALUES
(13, 3, 6, 1, 3, 'MTWRF', TO_DATE('09:00', 'HH:MI'), TO_DSINTERVAL('0 00:01:30.00'), 5, 35);
...
INSERT INTO enrollment VALUES (5, 11, NULL);
